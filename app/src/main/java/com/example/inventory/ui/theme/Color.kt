...
//Tema Fadhil punya
val md_theme_light_primary = Color(0xFF3A6D8C) // status bar
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFF3A6D8C) //button FAB
val md_theme_light_onPrimaryContainer = Color(0xFFDEE5D4)
val md_theme_light_secondary = Color(0xFF625B71)
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFFEF9D9) //shape2
...
val md_theme_light_background = Color(0xFFDEE5D4)
...
val md_theme_light_surfaceVariant = Color(0xFFFEF9D9) //shape
val md_theme_light_onSurfaceVariant = Color(0xFF181C14) //font color
...
val md_theme_dark_onBackground = Color(0xFF352F44)
val md_theme_dark_surface = Color(0xFF31363F)
val md_theme_dark_onSurface = Color(0xFFEEEEEE)
val md_theme_dark_surfaceVariant = Color(0xFF535C91)
val md_theme_dark_onSurfaceVariant = Color(0xFFFFFFFF)
val md_theme_dark_outline = Color(0xFF352F44)
